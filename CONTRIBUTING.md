Contributing to LucidAnimations
======================
...
4. If the pull request fixes a bug, create a new [issue](https://github.com/simdea/LucidAnimations/issues/new) with an explanation including what the bug was and how to reproduce it, then reference the issue in PR description.
...
* **DO NOT** commit code that you didn't write. If you find code that you think is a good fit to add to LucidAnimations, file an issue and start a discussion before proceeding.
